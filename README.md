...
#2 - Abra o Intellij e busque pelo projeto no desktop
...
#3 - Configurar o Banco de Dados (se aplicável)
...
#4 - Execute o arquivo LanchoneteApplication.java no diretorio src/main/java/com/br/api/lanchonete/LanchoneteApplication.java
